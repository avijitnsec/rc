...
"mappings - Tabbar, FZF, NERDTree, Switch Tab
...
"Immdately serach the word under the cursor
nmap <leader>u :tab split<CR>:Ack <C-r><C-w><CR>

" Fix vim's ridiculas line wraping model
set ww=<,>,[,],h,l
set colorcolumn=80
set textwidth=80
...
" Pree F5 to remove all the trailing white space
...
" Following autocmd is applicable only for pl type
